...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("robinkr67@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Munna@4457");
		...
		//ng-animating - class bname attribute for loading icon 
