package raubin.stepDefinitions;
...
public class StepDefinitionImpl extends BaseTest{
	...
	public void message_displayed_ConfirmationPage(String mesaage)
	{
		String confirmMessage = confirmPage.getConfirmationMessage();
		Assert.assertTrue(confirmMessage.equalsIgnoreCase(mesaage));
		driver.close();
	}
	
	@Then("^\"([^\"]*)\" message is displayed$")
	public void something_message_is_displayed(String error)
	{
